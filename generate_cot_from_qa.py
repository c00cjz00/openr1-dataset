...
def build_distilabel_pipeline(
    ...
    with Pipeline().ray() as pipeline:
        TextGeneration(
            ...
            input_mappings={"instruction": prompt_column, "system_prompt": "You will be given a problem with a reference answer. Please reason step by step and put your final answer within \boxed{} in Traditional Chinese (zh-TW)\n\n"} if prompt_column is not None else {},
